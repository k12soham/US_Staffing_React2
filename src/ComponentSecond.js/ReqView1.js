                    ...
                    <div class="wrapper">
                        ...
                        <nav class="main-header navbar navbar-expand navbar-white navbar-light">
                            ...
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item d-none d-sm-inline-block">
                                    <a href="#" class="nav-link">View Requisition</a>
                                </li>
                            </ul>
                        ...
                        <aside class="main-sidebar sidebar-dark-primary elevation-2">
                            ...
                            <a href="#" class="brand-link">
                                ...
                                <img src="../dist/img/t-cog.jpg" alt="TCOG Logo" class="brand-image elevation-12" style={{ opacity: '.100' }} />
                                {/* style="opacity: .8" */}
                                <span class="brand-text font-weight-light">tCognition</span>
                            </a>
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control select2" style={{ width: '100%' }}>
                                                            <option default selected>Alabama</option>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group clearfix">
                                                                <div class="icheck-primary d-inline">
                                                                    <input type="checkbox" id="checkboxPrimary1" readOnly />
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group clearfix">
                                                                <div class="icheck-primary d-inline">
                                                                    <input type="radio" id="radioPrimary1" name="r1" readOnly />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group clearfix">
                                                                <div class="icheck-danger d-inline">
                                                                    <input type="checkbox" id="checkboxDanger1" readOnly />
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group clearfix">
                                                                <div class="icheck-danger d-inline">
                                                                    <input type="radio" name="r2" readOnly id="radioDanger1" />
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group clearfix">
                                                                <div class="icheck-success d-inline">
                                                                    <input type="checkbox" readOnly id="checkboxSuccess1" />
                                                        ...
                                                        <div class="col-sm-6">
                                                            ...
                                                            <div class="form-group clearfix">
                                                                <div class="icheck-success d-inline">
                                                                    <input type="radio" name="r3" readOnly id="radioSuccess1" />
                                            ...
                                            <div class="card card-secondary">
                                                ...
                                                <div class="card-body">
                                                    <input type="checkbox" name="my-checkbox" readOnly data-bootstrap-switch />
                                                    <input type="checkbox" name="my-checkbox" readOnly data-bootstrap-switch data-off-color="danger" data-on-color="success" />
                                                </div>
                                            </div>
                                            {/* <!-- /.card --> */}
                                        </div>
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <div class="input-group">
                                                                        <div class="custom-file">
                                                                            ...
                                                                            <label class="custom-file-label" htmlFor="exampleInputFile">Choose file</label>
                                                                        </div>
                                                                        <div class="input-group-append">
